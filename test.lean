...
lemma le_of_succ_eq (a b : ℕ →₀ ℕ) (i  : ℕ) (hlei : le_aux a b i) (hi_succ : a (i + 1) = b (i + 1)) : le_aux a b (i + 1) :=
begin
    unfold le_aux,
...
begin 
    ...
    have htri := lt_trichotomy (max_ab a b) (max_ab (a + w) (b + w)),
    cases htri,
    begin
        cases (max_ab (a + w) (b + w)),
        cases htri,
        unfold le_aux at *, simp, apply or.inr,
    end,
    cases htri,
    begin
    ...
    /-
    all_goals {cases (max_ab a b); cases (max_ab (a + w) (b + w))}, 
    cases h, cases h,
    unfold le_aux at *, 
